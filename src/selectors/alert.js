...
export const getDurationContinuing = (state) => state.get('alert').isDurationContinuing
export const getErrorTimer = (state) => state.get('alert').errorTimer
export const getErrorDurationTimer = (state) => state.get('alert').errorDurationTimer
